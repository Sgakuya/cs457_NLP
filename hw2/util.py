...
def print_confusion_matrix(matrix: List[List[int]], labels: List[str],
    ...
    Args:
        ...
        cell_width (int, optional): minimum table cell width. Defaults to 5.
    """
    print(format_confusion_matrix(matrix, labels, cell_width=cell_width))


def format_confusion_matrix(matrix: List[List[int]], labels: List[str],
                           cell_width: int = 5) -> str:
    """
    Formats a given confusion matrix as a string
